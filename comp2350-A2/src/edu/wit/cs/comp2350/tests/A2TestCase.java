...
public class A2TestCase{
	...
	private void _testHeap(float[] values, float expected) {
		...
		assertEquals("Result is not close - not all values are added correctly.", expected, result, result/10000);
		assertEquals("Result has rounding error - values are not added in the correct order.", expected, result, 0);
